...
- The 18-month pandemic boom (Jan 2021–Jun 2022) delivered what normally takes 5–7 years.
- The Fed's 2022 rate hike cycle produced a cooling, not a crash — prices stayed well above pre-COVID levels.

**Model results**
- **Best model: Random Forest** — MAE $1,634 · MAPE 0.12% on 18-month holdout (Jan 2024–Jun 2025).
- Autoregressive lag features (1m, 3m rolling mean) explain >97% of predictive power.
